...
namespace Bakery.Migrations
{
    ...
    [Migration("20240404093546_Migration1")]
            ...
            modelBuilder.Entity("Bakery.Models.Batch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BakingGoodId = 1,
                            Delay = 20,
                            TargetFinishTime = new DateTime(2024, 4, 4, 13, 35, 45, 871, DateTimeKind.Local).AddTicks(1460),
                            TargetStartTime = new DateTime(2024, 4, 4, 11, 35, 45, 871, DateTimeKind.Local).AddTicks(1440),
                            TotalQuantityOrdered = 10
                        },
                        new
                        {
                            ...
                            BakingGoodId = 2,
                            Delay = 40,
                            TargetFinishTime = new DateTime(2024, 4, 4, 13, 35, 45, 871, DateTimeKind.Local).AddTicks(1480),
                            TargetStartTime = new DateTime(2024, 4, 4, 12, 35, 45, 871, DateTimeKind.Local).AddTicks(1470),
                            TotalQuantityOrdered = 20
                        },
                        new
                        {
                            ...
                            BakingGoodId = 3,
                            Delay = 50,
                            TargetFinishTime = new DateTime(2024, 4, 4, 14, 35, 45, 871, DateTimeKind.Local).AddTicks(1480),
                            TargetStartTime = new DateTime(2024, 4, 4, 13, 35, 45, 871, DateTimeKind.Local).AddTicks(1480),
                            TotalQuantityOrdered = 30
                        },
                        new
                        {
                            BatchId = 4,
                            BakingGoodId = 3,
                            TargetFinishTime = new DateTime(2024, 4, 4, 15, 35, 45, 871, DateTimeKind.Local).AddTicks(1480),
                            TargetStartTime = new DateTime(2024, 4, 4, 14, 35, 45, 871, DateTimeKind.Local).AddTicks(1480),
            ...
            modelBuilder.Entity("Bakery.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            DeliveryDate = new DateTime(2024, 4, 4, 19, 35, 45, 871, DateTimeKind.Local).AddTicks(1520),
                            DeliveryPlace = "Storcenter Nord, Aarhus N, Denmark"
                        },
                        new
                        {
                            OrderId = 2,
                            DeliveryDate = new DateTime(2024, 4, 4, 21, 35, 45, 871, DateTimeKind.Local).AddTicks(1520),
                            DeliveryPlace = "Coop 365, Aarhus C, Denmark"
                        },
                        new
                        {
                            OrderId = 3,
                            DeliveryDate = new DateTime(2024, 4, 4, 23, 35, 45, 871, DateTimeKind.Local).AddTicks(1530),
