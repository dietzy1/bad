...
namespace Bakery.Migrations
{
    ...
    [Migration("20240404110840_SeedAllergens")]
    partial class SeedAllergens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bakery.Models.Batch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BakingGoodId = 1,
                            Delay = 20,
                            TargetFinishTime = "04/04/2024 15.08.39",
                            TargetStartTime = "04/04/2024 13.08.39",
                            TotalQuantityOrdered = 10
                        },
                        new
                        {
                            ...
                            Delay = 40,
                            TargetFinishTime = "04/04/2024 15.08.39",
                            TargetStartTime = "04/04/2024 14.08.39",
                            TotalQuantityOrdered = 20
                        },
                        new
                        {
                            ...
                            BakingGoodId = 3,
                            Delay = 50,
                            TargetFinishTime = "04/04/2024 16.08.39",
                            TargetStartTime = "04/04/2024 15.08.39",
                            TotalQuantityOrdered = 30
                        },
                        new
                        {
                            BatchId = 4,
                            BakingGoodId = 3,
                            TargetFinishTime = "04/04/2024 17.08.39",
                            TargetStartTime = "04/04/2024 16.08.39",
            ...
            modelBuilder.Entity("Bakery.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeliveryDate = "04/04/2024 21.08.39",
                        ...
                        new
                        {
                            ...
                            DeliveryDate = "04/04/2024 23.08.39",
                        ...
                        new
                        {
                            ...
                            DeliveryDate = "05/04/2024 01.08.39",
